...
#         self.conv = DepthSeperabelConv2d(c1, c2, k)
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, c1, c2, shortcut=True, g=1, e=0.5):  # ch_in, ch_out, shortcut, groups, expansion
        ...
        self.cv1 = DepthSeperabelConv2d(c1, c_, 1)
        # self.cv2 = Conv(c_, c2, 3, 1, g=g)
        self.cv2 = DepthSeperabelConv2d(c_, c2, 3)
...
class BottleneckCSP(nn.Module):
    ...
    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5):  # ch_in, ch_out, number, shortcut, groups, expansion
        ...
        self.cv2 = DepthSeperabelConv2d(c1, c_, 1)
        # self.cv3 = nn.Conv2d(c_, c_, 1, 1, bias=False)
        self.cv3 = DepthSeperabelConv2d(c_, c_, 1)
        # self.cv4 = Conv(2 * c_, c2, 1, 1)
        self.cv4 = DepthSeperabelConv2d(2 * c_, c2, 1)
...
class SPP(nn.Module):
    ...
    def __init__(self, c1, c2, k=(5, 9, 13)):
        ...
        self.cv2 = DepthSeperabelConv2d(c_ * (len(k) + 1), c2, 1)
...
class Focus(nn.Module):
    ...
    def __init__(self, c1, c2, k=1, s=1, p=None, g=1, act=True):  # ch_in, ch_out, kernel, stride, padding, groups
        ...
        self.conv = DepthSeperabelConv2d(c1 * 4, c2, k)
